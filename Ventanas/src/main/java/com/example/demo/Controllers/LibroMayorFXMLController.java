...
public class LibroMayorFXMLController implements Initializable{
	...
	@FXML protected void  onGenerarReporteBotonClicked(ActionEvent actionEvent) {
		...
		try{
			ResponseEntity<byte[]> respuesta = restTemplate.postForEntity(INIT_URL + "/reportes/libroMayor/imprimir", mesSeleccionado, byte[].class);
        ...
        alert.setTitle("Generar reporte : Libro Mayor");
