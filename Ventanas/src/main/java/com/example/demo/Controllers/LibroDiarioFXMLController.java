...
public class LibroDiarioFXMLController implements Initializable{
	...
	@FXML protected void  onGenerarReporteBotonClicked(ActionEvent actionEvent) {
		...
		try{
			ResponseEntity<byte[]> respuesta = restTemplate.postForEntity(INIT_URL + "/reportes/libroDiario/imprimir", mesSeleccionado, byte[].class);
        ...
        alert.setTitle("Generar reporte : Libro Diario");
