...
public class BalancePruebaFXMLController implements Initializable{
	...
	@FXML protected void  onGenerarReporteBotonClicked(ActionEvent actionEvent) {
		...
		try{
			ResponseEntity<byte[]> respuesta = restTemplate.postForEntity(INIT_URL + "/reportes/balancePrueba/imprimir", mesSeleccionado, byte[].class);
        ...
        alert.setTitle("Generar Balance de Prueba");
