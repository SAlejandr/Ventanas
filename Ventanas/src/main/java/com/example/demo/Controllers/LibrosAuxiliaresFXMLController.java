...
public class LibrosAuxiliaresFXMLController implements Initializable{
	...
	@FXML protected void  onGenerarReporteBotonClicked(ActionEvent actionEvent) {
		...
		try{
			ResponseEntity<byte[]> respuesta = restTemplate.postForEntity(INIT_URL + "/reportes/librosAuxiliares/imprimir", mesSeleccionado, byte[].class);
        ...
        alert.setTitle("Generar reporte : Libros Auxiliares");
