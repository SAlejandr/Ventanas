...
public class TerceroFXMLController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		// TODO Auto-generated method stub
			...
			TableColumn<TerceroDTO, NaturalezaJuridica> columna2 = new TableColumn<>("Naturaleza juridica");
			TableColumn<TerceroDTO, Tipo_Identificacion> columna3 = new TableColumn<>("Tipo_Identificacion");
			TableColumn<TerceroDTO, String> columna4 = new TableColumn<>("Nombre");
			TableColumn<TerceroDTO, String> columna5 = new TableColumn<>("Email");
			TableColumn<TerceroDTO, String> columna6 = new TableColumn<>("Direccion");
			TableColumn<TerceroDTO, String> columna7 = new TableColumn<>("Ciudad");
			TableColumn<TerceroDTO, String> columna8 = new TableColumn<>("Telefono1");
			TableColumn<TerceroDTO, String> columna9 = new TableColumn<>("Telefono2");
			...
			columna6.setCellValueFactory(new PropertyValueFactory<>("direccion"));
			columna7.setCellValueFactory(new PropertyValueFactory<>("ciudad"));
			columna8.setCellValueFactory(new PropertyValueFactory<>("telefono1"));
			columna9.setCellValueFactory(new PropertyValueFactory<>("telefono2"));
	...
	@FXML public void refrescarLista(){
		...
		try {
			...
			consumerTercero.forEach(t -> {
				terceros.put(t.getId(), t);
			...
			alert.setTitle("Listas");
			alert.setContentText("No se pudo actualizar datos");
			alert.showAndWait();
		}
	...
	@FXML public void borrar() throws IOException {
		...
		if(borrado) {
			TerceroDTO dto = (TerceroDTO) tabla.getSelectionModel().getSelectedItem();
